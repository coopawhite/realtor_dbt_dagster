...
WITH raw_property_list AS (
    SELECT
        *
    FROM {{ source('raw', 'realtor_properties_list') }}
),
...
SELECT
    ...
    , ad.advertiser_type
    , a.flags['is_price_reduced'] AS is_price_reduced
    , a.flags['is_new_construction'] AS is_new_construction
    , a.flags['is_foreclosure'] AS is_foreclosure
    , a.flags['is_plan'] AS is_plan
    , a.flags['is_new_listing'] AS is_new_listing
    , a.flags['is_coming_soon'] AS is_coming_soon
    , a.flags['is_contingent'] AS is_contingent
    , a.flags['is_pending'] AS is_pending
    , source_agent_id
    , source_agent_name
    , source_office_id
    , source_office_name
    ...
    , a.estimate['estimate'] as estimate
